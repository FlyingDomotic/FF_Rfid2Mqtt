...
char wifiSSID[] = "freebox_DGOAMX";                                 // SSID to connected to
                                                                    // SSID auquel se connecter
//char wifiKey[] = "MyPassword";                                    // SSID password
char wifiKey[] = "Q3f*hj61!9L:";                                    // SSID password
...
char mqttServer[] = "192.168.98.92";                                // MQTT server IP address or name
...
char mqttUsername[] = "pi";                                         // MQTT username
                                                                    // Utilisateur MQTT
//char mqttPassword[] = "MyMqttPassword";                           // MQTT password
char mqttPassword[] = "Mvqvlnd0Mc@bO";                              // MQTT password
                                                                    // Mot de passe MQTT
...
//    char syslogServer[] = "192.168.1.1";                          // Syslog server IP address or name
    char syslogServer[] = "192.168.98.109";                         // Syslog server IP address or name
